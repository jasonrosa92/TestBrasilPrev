...
class Board(object):
    ...
    def __create_board(self):
        self.properties = [Property()]  # Propriedade de indice 0 (Marca o ponto de Partida)
        properties = map(lambda x: Property.create(), range(self.qty_properties))
